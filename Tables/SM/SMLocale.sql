...
-- SMLocale
----------------------------------------------------------------
DROP TABLE IF EXISTS [dbo].[SMLocale];
CREATE TABLE [dbo].[SMLocale]
(
	...
	[NumberDecimalSeparator] [nvarchar](8) NULL,
...
GO
CREATE NONCLUSTERED INDEX [SMLocale_Default] ON [dbo].[SMLocale] ([IsDefault]) WHERE [IsDefault] = 1
GO